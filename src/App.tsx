...
import { Home, TrendingUp, Heart, Menu, Upload, Search, X, Play, MoreVertical } from 'lucide-react';
...
function PlayerContainer({ video }: { video: Video }) {
  return (
    <div className="w-full aspect-video bg-black rounded-2xl overflow-hidden relative border border-white/10 shadow-lg">
      {/* 
